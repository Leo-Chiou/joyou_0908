...
<script type="text/javascript">
	window.onload = function() {
		...
		function displayPageProducts(responseData) {
			var content = "<tr><td>商品圖片</td><td>商品名稱</td><td>商品庫存</td><td>商品價格</td><td>建議年齡</td><td>建議人數</td><td>操作</td></tr>";
			;
			...
			for (var i = 0; i < products.length; i++) {
				...
				content += "<td><button data-toggle='tooltip' title='編輯' onClick='productUpdate(this)' value='"
					+ products[i].productId + "' class='pd-setting-ed'>";
				content += "<i class='fa fa-pencil-square-o' aria-hidden='true'></i>";
				content += "</button><button data-toggle='tooltip' title='刪除' onClick='productDelete(this)' value='"
						+ products[i].productId + "' class='pd-setting-ed'>";
		...
		<nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="Index_Maintain.jsp"><img src="img/logo/joyou-210.png"
						alt="" /></a>
					<h2>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="logo-pro">
						<a href="Index_Maintain.jsp"><img class="main-logo"
							src="img/logo/funnydog1.png" alt="" /></a>
					</div>
				</div>
			</div>
		</div>

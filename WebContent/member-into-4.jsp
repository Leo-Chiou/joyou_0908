          ...
          <div class="cart_step_bg1 center_step">
            ...
            <div class="SB_MemberFinal">
                                    <div class="SB_MemberFinal_in  SB_tablemarginB30">
                                        <p><span id="StringOfNickName"></span> 您好，您的帳號已順利開通，
                    </p><p>即刻登入立即享有會員權益。<!--即刻登入立即享有會員權益。--></p>
                </div>
                <div class="SB_MemberSignnow_btn jooshop_btn_color"><a href="login.jsp">立即登入</a></div>
            </div>
</div>      
</div>
<!---->

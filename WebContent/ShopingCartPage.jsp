                ...
                <div class="col-lg-12">
                    <div class="shoping__cart__table">
                        <table>
                            ...
                            <tbody>
                            <c:forEach varStatus="vs" var="orderItemBean" items="${ShoppingCart.content}">
                                <tr>
                                    <td class="shoping__cart__item">
                                        <h5>${orderItemBean.value.productName}</h5>
                                    </td>
                                    <td class="shoping__cart__price">
                                        NT.${orderItemBean.value.productPrice}
                                    </td>
                                    <td class="shoping__cart__quantity">
                                        <div class="quantity">
                                            <div class="pro-qty">
                                    <Input id="newQty${vs.index}" style="width:28px ; border:none; text-align:right" name="newQty" type="text" value="<fmt:formatNumber value="${orderItemBean.value.orderitemQty}" />" name="orderitemQty" onkeypress="return isNumberKey(event)"  />
                                            </div>
                                        </div>
                                    </td>
                                    <td class="shoping__cart__total">
                                        NT.${orderItemBean.value.totalPrice}
                                    </td>
                                    <td class="shoping__cart__item__close">
               							<Input style="background:#FFD306;float:left; color: black; text-align: center; outline: 0; border: 0; box-sizing: border-box; font-size: 10px;" type="button" name="delete" value="刪除" onclick="confirmDelete(${orderItemBean.key})">
               							 <Input style="background:#FFD306; float:left;color: black; text-align: center; outline: 0; border: 0; box-sizing: border-box; font-size: 10px;" type="button" name="update" value="更新" onclick="modify(${orderItemBean.key}, ${orderItemBean.value.orderitemQty}, ${vs.index})">
                                    </td>
                                </tr>
                                </c:forEach>
                            </tbody>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        <a href="ProductsGetServlet.do" class="primary-btn cart-btn">還買不夠？</a>
